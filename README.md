...
- [x] User can **compose and post a new tweet**
  - [x] User can click a “Compose” icon in the Action Bar on the top right 
    - Changed to a FloatingActionButton in Stretch Stories
...
<img src='walkthrough2_.gif' title='Video Walkthrough 2' width='' alt='Video Walkthrough 2' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Noticed and fixed a bug caused by TimeFormatter when recording the walkthrough gif.
...
## Notes
Twitter's rate limit was causing trouble when I was tring to record the walkthrough gif.
